 ...
 * 
 * 클래스 변수(정적변수), 클래스 메서드(정적 메서드)
 * - Static으로 선언한 변수와 메서드
 * - Mothod Area 영역에 따로 관리된다.
...
public class StaticTest {
	...
	*
	*/
		// 여러개 객체를 생성할 필요가 없는 객체 aka 여러개 객체를 생성할 때
		// 싱글톤으로 했다면 new 로 더이상 객체가 생성되지 못하게 해야됨
		// Calc cal = new Calc();
		...
		System.err.println("1 + 2 : " + c1.plus(1,2));
		System.err.println("1 - 2 : " + c2.minus(1,2));
		System.err.println("2 * 3 : " + c3.multi(2, 3));
		System.err.println("4 / 2 : " + c4.div(4,2));
