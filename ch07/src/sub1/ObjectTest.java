...
public class ObjectTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(a2); // toString()은 default 메서드이기 때문에 객체 이름으로 출력가능
		
		// 객체 비교
		if (a1 == a2) {
			System.out.println("a1과 a2가 주소 값 같다.");
		}else {
			System.out.println("a1과 a2가 주소 값 다르다.");
		}
		
		if (a1.equals(a2)) {
			System.out.println("a1과 a2 객체가 같다.");
		}else {
			System.out.println("1과 a2객체가 다르다.");
		}
